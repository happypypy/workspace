    ...
    public override void Process()
    {
        ...
        WriteJson(new
        {
            ...
            list = Crawlers.Select(x => new
            {
                state = x.State,
                source = x.SourceUrl,
                url = Request.Url.GetLeftPart(UriPartial.Authority)+"/"+ x.ServerUrl
            })
        });
    }
}
...
public class Crawler
{
    ...
    private string GetExtentByContextType(string Contenttype)
    {
    ...
    public Crawler Fetch()
    {
        ...
        WebRequest request = WebRequest.Create(this.SourceUrl);
        using (var response = request.GetResponse() as HttpWebResponse)
        {
            ...
            {
                ServerUrl +=  GetExtentByContextType(response.Headers["Content-Type"]);
            }
