...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl:  "/Admin/Ueditorr/index"
        , imageUrlPrefix: "http://192.168.168.90/"
        ,catcherUrlPrefix:""
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
        , toolbars: [[
            'source',/* '|', 'remotecontent','135editor',*/
            'bold', 'italic', 'underline','superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote','|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','cleardoc', '|',
            'rowspacingtop', 'rowspacingbottom', 'lineheight', '|','horizontal','spechars',
    ...
    console.log(window.UE.getUEBasePath());
