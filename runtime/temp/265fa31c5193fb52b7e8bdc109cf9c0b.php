<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\sitemanage\index.html";i:1561691683;}*/ ?>
                                        ...
                                        <div class="oa_text-list">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
                                                <tr class="oa_text-list-title">
                                                    ...
                                                    <th width="60"><span class="oa_arr-text-list-title"></span>站点代号</th>
