<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\report\index.html";i:1561691687;}*/ ?>
                    ...
                    <div class="oa_subnav clearfix">
                        <div class="oa_subnav-tab clearfix">
                            <ul>
                                ...
                                <li class="oa_on" onclick="javascript:window.location='<?php echo url('report/index',''); ?>'"><em>会员增减报表</em></li>
                                ...
                                <li onclick="javascript:window.location='<?php echo url('report/activity',''); ?>'"><em>活动报表</em></li>
                                <?php } ?>
                    ...
                    <div class="oa_text-list">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
                            ...
                            <tr>
                                ...
                                <td><?php echo $vo["visit_count"]; ?></td>
                                <?php endif; ?>
                                <td><?php echo $vo["follow"]; ?></td>
                                <td><?php echo $vo["unfollow"]; ?></td>
                                <td><?php echo $vo["increase"]; ?></td>
                                <td><?php echo $vo["visitor"]; ?></td>
                            </tr>
