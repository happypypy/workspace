<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"template/M2/mine/order_detail.html";i:1562307602;s:68:"C:\phpStudy\PHPTutorial\WWW\work\public\template\M2\lib\footer0.html";i:1561691698;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<form class="information-list">
    <ul>
        ...
        <li>
            ...
            <div class="txt">
                <div class="info">
                    <span class="name" style="cursor:pointer;" onclick="javascript:window.location='/<?php echo $sitecode; ?>/detail/<?php echo $orderinfo['dataid']; ?>'"><?php echo $orderinfo['chrtitle']; ?></span>
                </div>
            </div>
        </li>
        <li>
        ...
        <li>
            ...
            <div class="txt">
                <div class="info">
                    <?php echo $order_state[$orderinfo['state']]; ?> </span>
