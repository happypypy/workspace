<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\account\accountlist.html";i:1561691685;}*/ ?>
                        ...
                        <tr>
                          <td>
                            <div class="oa_search-type clearfix">
                              <form action="<?php echo url('account/accountlist'); ?>" method="post" id="form1">
                      ...
                      <span class="oa_title-btn">
                        <ul>
                          ...
                          <li class="oa_selected">
                            <a href="javascript:CustomOpen('<?php echo url('account/accountdeal','&action=add',''); ?>', 'account','<?php echo lang('account add'); ?>', 400, 370)"><?php echo lang('add account'); ?></a>
                          </li>
                          <?php } ?>
                        </ul>
                      </span>
                    ...
                    <div class="oa_text-list" id="ajaxpage">
                      <table id="table" width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
                        <tr class="oa_text-list-title">
                          ...
                          <th width="50"><span class="oa_arr-text-list-title"></span><?php echo lang('account id'); ?></th>
                          <th width="60"><span class="oa_arr-text-list-title"></span><?php echo lang('account'); ?></th>
                          <th width="70"><span class="oa_arr-text-list-title"></span><?php echo lang('account name'); ?></th>
                          <th width="30"><span class="oa_arr-text-list-title"></span><?php echo lang('status'); ?></th>
                          ...
                          <tr class="tr">
                              ...
                              <td><span><?php echo $vo['idaccount']; ?></span></td>
                              ...
                              <td><?php echo $vo['intsn']; ?></td>
                              <td><?php echo $vo['chrremark']; ?></td>
                              <td>
                                <a href="javascript:CustomOpen('<?php echo url('admin/account/accountdeal','id='.$vo['idaccount'].'&action=view',''); ?>', 'account','<?php echo lang('account check'); ?>', 400, 340)"><?php echo lang('check'); ?></a>

                                <?php if($cms->CheckPurview('accountmanage','edit')){ ?>
                                  <a href="javascript:CustomOpen('<?php echo url('account/accountdeal','id='.$vo['idaccount'].'&action=edit',''); ?>', 'account','<?php echo lang('account editor'); ?>', 400, 370)"><?php echo lang('revise'); ?></a>
                                <?php } if($cms->CheckPurview('accountmanage','roleset')){ ?>
                                <a href="javascript:CustomOpen('<?php echo url('account/roleset','id='.$vo['idaccount'],''); ?>', 'account','<?php echo lang('choice role'); ?>', 500, 300)"><?php echo lang('role'); ?></a>
