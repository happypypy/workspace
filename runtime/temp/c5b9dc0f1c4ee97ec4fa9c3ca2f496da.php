<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:27:"template/M1/node/index.html";i:1565240343;s:52:"D:\workspace\work\public\template\M1\lib\header.html";i:1561691693;s:53:"D:\workspace\work\public\template\M1\lib\footer0.html";i:1561691693;s:52:"D:\workspace\work\public\template\M1\lib\footer.html";i:1561691693;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
			...
			<div class="classify-choose flex flex-middle">
				...
				<div class="select" style=" float: right;width: 30%;">
					<select name="zxbqid" style="float: right" >
						...
						<option value="<?php echo $key; ?>"  <?php if( isset($_POST['zxbqid']) && $key==$_POST['zxbqid']?$_POST['zxbqid']:0) { echo "selected"; } ?> ><?php echo $vo; ?></option>
