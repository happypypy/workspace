                        ...
                        <td colspan="2" style="padding: 0">
                            ...
                            <tr class="paytypecontent2">
                                ...
                                <td>
                                    ...
                                    <input style="border:none;text-align:center;width: 60px;" readonly="true" type="text" class="oa_input-100"  value="市场价" />
                                    ...
                                    <input style="border:none;text-align:center;width: 65px;<?php if($datainfo['is_distribution']!=1 || !$is_distribution) { echo 'display: none;'; } ?>" readonly="true" type="text" id="sell_commission" class="oa_input-100" value="销售佣金" />
                                    <input style="border:none;text-align:center;width: 65px;<?php if($datainfo['is_distribution']!=1 || !$is_distribution) { echo 'display: none;'; } ?>" readonly="true" type="text" id="bounty_commission" class="oa_input-100" value="奖励金" />
                                ...
                                <tr class="paytypecontent2">
                                    ...
                                    <td id="selcontent_<?php echo $selcontent_index + 1; ?>">
                                        <!-- <div> -->
                                            ...
                                            <input name="packages[<?php echo $selcontent_index; ?>][original_price]" type="text" class="original_price oa_input-100 number" value="<?php echo $value['original_price']; ?>" style="width: 60px;"/>
                                          ...
                                          <input name="packages[<?php echo $selcontent_index; ?>][sell_commission]" type="text" class="sell_commission oa_input-100 number" value="<?php echo $value['sell_commission']; ?>" style="width: 65px;<?php if($datainfo['is_distribution']!=1 || !$is_distribution) { echo 'display: none;'; } ?>" />
                                            <input name="packages[<?php echo $selcontent_index; ?>][bounty_commission]" type="text" class="bounty_commission oa_input-100 number" value="<?php echo $value['bounty_commission']; ?>" style="width: 65px;<?php if($datainfo['is_distribution']!=1 || !$is_distribution) { echo 'display: none;'; } ?>" />
