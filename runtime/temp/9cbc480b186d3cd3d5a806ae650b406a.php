<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\index\login.html";i:1561691687;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="index-table">
        <div class="index-table-cell">
            <div class="login-content">
                ...
                <form class="login-form" id="form1" method="post" action="<?php echo url('admin/index/login'); ?>">
                    <div class="login-item login-item1">
