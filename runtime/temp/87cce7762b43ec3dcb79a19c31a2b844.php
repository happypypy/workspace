<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\activity\modi.html";i:1562211080;}*/ ?>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <select name="packages[<?php echo $selcontent_index; ?>][group_buy][<?php echo $groupBuyIndex; ?>][allow_refund]"  class="form-control" style="width: auto; height: 34px">
                                                                    <option value="1" <?=$groupBuy['time_limit_type'] == 1 ? 'selected="selected"' : ''?> >是</option>
                                                                    <option value="0" <?=$groupBuy['time_limit_type'] == 0 ? 'selected="selected"' : ''?> >否</option>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                            <tr>
