<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\signup\index.html";i:1562315962;}*/ ?>
            ...
            try {
                if (typeof(obj) != null && typeof(obj) != "undefined") {
                    ...
                    if (typeof(obj.return_function) == "function") {
                        obj.return_function(name,value);
                    }
                }
            }
            catch(e){
                    ...
                    <div class="oa_subnav clearfix">
                        ...
                        <div class="oa_subnav-tab clearfix">
                            <ul>
                                ...
                                <li  onclick="javascript:window.location='<?php echo url('Signup/allindex'); ?>'"><em>所有模版</em></li>
                            </ul>
                        </div>
                                    ...
                                    <td valign="top">
                                        ...
                                        <div class="oa_text-list">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
                                                ...
                                                <tr>
                                                    <td align="center"><input class="checked_one" <?php echo $vo['state']==1?'style="display:none"':'' ?> type="checkbox" id="del_s_<?php echo $vo['id']; ?>" name="id[]" value="<?php echo $vo['id']; ?>"/></td>
                                                    <td><?php echo $vo['title']; ?></td>
                                                    <td><?php echo $vo['remark']; ?></td>
                                                    <td><?php echo $vo['username']; ?></td>
                                                    <td>
                                                        <img width="20" height="20" src="/static/images/<?php echo $vo['issub']==1?'yes':'cancel' ?>.png" onclick="changeTableVal('signup_template','id','<?php echo $vo['id']; ?>','issub',this)"/>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:window.location='<?php echo url('Signup/indexsub1',array('pid'=>$vo['id'])); ?>'">子表单</a>
                                                        ...
                                                        <a id="del_<?php echo $vo['id']; ?>" <?php echo $vo['state']==1?'style="display:none"':'' ?>  href="#" onclick="del_checked(<?php echo $vo['id']; ?>,'<?php echo $vo['title']; ?>');" >删除</a>
                                                        <?php } ?>
