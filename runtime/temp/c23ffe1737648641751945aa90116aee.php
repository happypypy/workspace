<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\workspace\work\public/../application/admin\view\pattern\modelfieldinfo.html";i:1561691683;}*/ ?>
                        ...
                        <ul>
                          <li class="oa_selected">
							  <a href="<?php echo url('pattern/index',['idsite'=>1]); ?>">返回</a>
											...
											模型字段列表：<a href="<?php echo url('pattern/modelfieldall','idmodel='.$request['idmodel']); ?>">所有字段</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo url('pattern/modelfieldinfo','idmodel='.$request['idmodel']); ?>" style="color: #2E00FF">正在使用字段</a>
										</div>
										...
										<div class="oa_text-list">
											<table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
												...
												<tr>
													...
													<td>
														<input style="width: 60px" class="idorder" onblur="changeSort('<?php echo $vo['idtypefield']; ?>',this);" type="text" name="idorder" value="<?php echo $vo['idorder']; ?>" />
													</td>
													<?php if($cms->CheckPurview('modelfield','edit')){ ?>
													<td width="100">
														<a href="javascript:CustomOpen('<?php echo url('pattern/fielddeal','idmodel='.$request['idmodel'].'&idfield='.$vo['idtypefield'].'&action=edit&idsite='.$idsite); ?>','role','字段内容修改',700, 500)"><?php echo lang('revise'); ?></a>
													</td>
													<?php } ?>
												</tr>
