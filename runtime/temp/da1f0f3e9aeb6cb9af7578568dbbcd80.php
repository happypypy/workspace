<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:34:"template/M4/order/again_order.html";i:1565160937;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <ul>
        ...
        <li>
            <div class="txt">
                ...
                if($order_info['stock_locked']==0){
                $paynum=$order_info['paynum'];
                $order_info['paynum']=0;
                }
                ?>
                <div class="pwclass pw <?php if($package['package_id'] == $order_info['package_id']){echo 'pwon';} ?>" Stock="<?php if($package['stock'] === '不限'){echo $package['stock']; }else{ echo $package['stock']+$order_info['paynum']; } ?>" price="<?php echo $package['member_price']; ?>"  data="<?php echo $package['package_id']; ?>">
                    <!-- 关键字 -->
                    <?php echo $keyword; ?>
                    <span ><?php echo $price; ?></span>
                    [库存：<?php if($package['stock'] === '不限'){echo $package['stock'];}else{ echo $package['stock']+$order_info['paynum']; } ?>]
                </div>
                <?php } }?>     <!-- endforeach -->
                    ...
                    if (commonid == 4134) {
                        ...
                        <?php endif; ?>
                            ...
                            if (commonid == 4134) {
                                ...
                                function loadprice() {
                                    //使用的现金券金额
                                    var cashed_amount = <?php echo $order_info['cashed_amount']; ?>;
