<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:22:"template/M4/index.html";i:1561971913;s:67:"C:\phpStudy\PHPTutorial\WWW\work\public\template\M4\lib\header.html";i:1561691701;s:68:"C:\phpStudy\PHPTutorial\WWW\work\public\template\M4\lib\footer0.html";i:1561691701;s:67:"C:\phpStudy\PHPTutorial\WWW\work\public\template\M4\lib\footer.html";i:1561691701;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="site-section clearfix bg">
		...
		<div class="banner bgw">
			<div class="swiper-container swiper1">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide"><a href="<?php echo $v['ad_link']==''?'javascript:;':$v['ad_link']; ?>"><img
								src="<?php echo $v['ad_code']; ?>"></a></div>
					<?php }} else { ?>
					<div class="swiper-slide"><a href="javascript:;"><img src="<?php echo $roottpl; ?>/images/banner_01.jpg"></a>
					</div>
					<?php } ?>
				</div>
			</div>
		...
		<div class="combox bgw">
			...
			<ul class="common-list">
				...
				<li>
					<a
						href="<?php echo (empty($val['chrurl'])?'/'.$sitecode.'/detail/'.$val['idactivity']:$val['chrurl']) ?>">
		...
		<div class="bar" <?php if(count($result)<5) echo "style='padding-top:1rem;'" ?>>
			<div class="banner">
				<div class="swiper-container swiper2">
					<div class="swiper-wrapper ">
						<?php
											$result1=$cms->getAD($idsite,51327,3);
										if($result1){
										foreach($result1 as $k=>$v){ ?>
						<div class="swiper-slide"><a href="<?php echo $v['ad_link']==''?'javascript:;':$v['ad_link']; ?>"><img
									src="<?php echo $v['ad_code']; ?>"></a></div>
						<?php }} else { ?>
						<div class="swiper-slide"><a href="javascript:;"><img class="swiper-slideImg"
									src="<?php echo $roottpl; ?>/images/bar_03.jpg"></a></div>
						<?php } ?>
					</div>
		...
		<div class="combox bgw">
			...
			<ul class="common-list">
				...
				<li>
					<a
						href="<?php echo (empty($val['linkurl'])?'/'.$sitecode.'/content/'.$val['contentid']:$val['linkurl']) ?>">
	...
	<script>
		...
		$(function () {
			//padding-top:
			var swiper1 = new Swiper('.banner .swiper-container.swiper2', {
				pagination: {
					el: '.banner .swiper-pagination',
				},
				autoplay: {
