<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\rolesite\columninfo.html";i:1561691683;}*/ ?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td valign="top">
                                        ...
                                        <form action="<?php echo url('rolesite/purviewpost'); ?>" method="post">
                                                    ...
                                                    <div class="clearfix">
                                                        <div class="oa_op-btn clearfix">
                                                           ...
                                                           <!-- <input type="hidden" name="module[]" value="<?php echo $v2['chrmodulecode']; ?>">
                                                            ...
                                                            <input name="" value="<?php echo lang('return'); ?>"  onclick="javascript:window.location='<?php echo url('admin/rolesite/index'); ?>';" type="button" class="oa_input-submit" />
                                                        </div>
                                                    </div>
