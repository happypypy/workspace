<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\menu\modulist.html";i:1561691686;}*/ ?>
...
function model_change() {
    ...
    $.ajax({
        ...
        data:"id="+s+"&chrcolumncode="+val+"&flag=module&change=2",
...
function del_checked() {
    ...
    $.ajax({
        ...
        data:"type=module&flag=module&id="+s,
        type:"post",
        dataType:"json",
        success:function(msg){
            if (msg==1){
        ...
        <div class="oa_main clearfix">
        	<div class="oa_subnav clearfix">
             ...
             <ul>
               ...
               <li class="oa_on"><em><a href="<?php echo url('menu/modulist'); ?>"><?php echo lang('module manage'); ?></a></em></li>
                    ...
                    <div class="oa_search-area clearfix">
                        ...
                        <tr>
                          <td>
                            <div class="oa_search-type clearfix">
                              <form action="<?php echo url('menu/modulist'); ?>">
                      ...
                      <span class="oa_title-btn">
                        <ul>
                          ...
                          <li class="oa_selected"><a href="javascript:CustomOpen('<?php echo url('menu/modudeal','&action=add&flag=module',''); ?>', 'account','<?php echo lang('module add'); ?>', 400, 430)"><?php echo lang('module add'); ?></a></li>
                          <?php } ?>
                        </ul>
                      </span>
                      <span class="oa_ico-left"></span>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
                        ...
                        <tr>
                          ...
                          <td width="100">
                            ...
                            <a href="javascript:CustomOpen('<?php echo url('menu/modudeal','code='.$vo['chrcode'].'&action=edit&flag=module',''); ?>', 'account','<?php echo lang('revise'); ?>', 400, 440)"><?php echo lang('revise'); ?></a>
                            <?php } if($cms->CheckPurview('modulemanage','del')){ ?>
                            <a onclick="javascript:if(confirm('确定删除吗？')){return true;}else{return false;};" href="<?php echo url('menu/del','modulecode='.$vo['chrcode'].'&id='.$vo['idmodule'].'&flag=module',''); ?>"><?php echo lang('delete'); ?></a></td>
                            <?php } ?>
                          </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
