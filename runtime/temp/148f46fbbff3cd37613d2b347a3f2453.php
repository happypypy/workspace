<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\role\index.html";i:1561691688;}*/ ?>
                                        ...
                                        <div class="oa_title clearfix">
                                            ...
                                            <ul>
                                              ...
                                              <li class="oa_selected">
                                                  <a href="javascript:CustomOpen('<?php echo url('role/roledeal','&action=add',''); ?>', 'role','<?php echo lang('role add'); ?>', 380,220)"><?php echo lang('role add'); ?></a>
                                              </li>
                                              <?php } ?>
                                            </ul>
                                            </span>
                                        ...
                                        <div class="oa_text-list">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
                                                <tr class="oa_text-list-title">
                                                    ...
                                                    <th width="50"><span class="oa_arr-text-list-title"></span><?php echo lang('role id'); ?></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span><?php echo $vo['idrole']; ?></span></td>
                                                    <td><?php echo $vo['rolename']; ?></td>
                                                    <td><?php echo $vo['idsite']; ?></td>
                                                    <td><?php echo $vo['roleremark']; ?></td>
                                                    <td width="100">
                                                        <a href="javascript:CustomOpen('<?php echo url('role/roledeal','id='.$vo['idrole'].'&action=view',''); ?>', 'role','<?php echo lang('role view'); ?>', 380,200)"><?php echo lang('check'); ?></a>

                                                        <?php if($cms->CheckPurview('rolemanage','edit')){ ?>
                                                        <a href="javascript:CustomOpen('<?php echo url('role/roledeal','id='.$vo['idrole'].'&action=edit',''); ?>','role','<?php echo lang('role edit'); ?>',380,220)"><?php echo lang('revise'); ?></a>
                                                        <?php } if($cms->CheckPurview('rolemanage','purviewset')){ ?>
                                                        <a href="<?php echo url('role/columninfo','roleid='.$vo['idrole'],''); ?>"><?php echo lang('purview set'); ?></a>
                                                        <?php } if($cms->CheckPurview('rolemanage','del')){ ?>
                                                        <a onclick="javascript:if(confirm('确定删除吗？')){return true;}else {return false;};" href="<?php echo url('role/roledel','id='.$vo['idrole'],''); ?>"><?php echo lang('delete'); ?></a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
