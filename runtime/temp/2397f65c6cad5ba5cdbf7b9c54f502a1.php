<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:31:"template/M1/activity/index.html";i:1562576748;s:52:"D:\workspace\work\public\template\M1\lib\header.html";i:1561691693;s:53:"D:\workspace\work\public\template\M1\lib\footer0.html";i:1561691693;s:52:"D:\workspace\work\public\template\M1\lib\footer.html";i:1561691693;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
		...
		<ul class="common-list" id="data">
			...
			<li>
				<a href="<?php echo (empty($val['chrurl'])?'/'.$sitecode.'/detail/'.$val['idactivity']:$val['chrurl']) ?>">
					...
					<div class="word">
						<div class="tit">
							<?php if($val['is_receive_cashed'] == 1 && $is_cashed): ?><span class="iconfont coupon-link">&#xe624;</span><?php endif; ?><?php echo $val['chrtitle']; ?></div>
