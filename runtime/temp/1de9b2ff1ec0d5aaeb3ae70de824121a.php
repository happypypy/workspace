<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\systemupdate\index.html";i:1561691688;}*/ ?>
                                    ...
                                    <td valign="top">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="oa_search-type clearfix">
                                                            <form action="<?php echo url('systemupdate/index'); ?>" method="post" id="form1">
                                        ...
                                        <div class="oa_title clearfix">
                                            <span class="oa_title-btn">
                                                <ul>
                                                    <?php if($cms->CheckPurview('systemupdatemanage','add')): ?>
                                                    <li class="oa_selected">
                                                        <a href="javascript:CustomOpen('<?php echo url('systemupdate/edit','&action=add'); ?>', 'Integralmall','新建系统更新', 1000,600)">新建系统更新</a>
                                                    </li>
                                                    <?php endif; ?>
                                                </ul>
                                            </span>
                                            <span class="oa_ico-left"></span>系统更新
                                        </div>
                                        <div class="oa_text-list">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($cms->CheckPurview('systemupdatemanage','edit')): ?>
                                                        <a href="javascript:CustomOpen('<?php echo url('systemupdate/edit','action=edit&id='.$vo['id'],''); ?>','modi','系统更新修改',1000,600)">修改</a>
                                                        <?php endif; if($cms->CheckPurview('systemupdatemanage','del')): ?>
                                            ...
                                            <div class="oa_bottom clearfix">
                                                <div class="clearfix">
                                                    <div class="oa_op-btn clearfix">
                                                        <?php if($cms->CheckPurview('systemupdatemanage','del')): ?>
...
<script type="text/javascript">
    ...
    function del_checked1(value) {
        ...
        $.ajax({
            url:"<?php echo url('systemupdate/delete'); ?>",
            data:"id="+s,
            type:"post",
            dataType:"json",
