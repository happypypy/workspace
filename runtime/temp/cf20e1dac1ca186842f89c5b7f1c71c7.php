<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\index\index.html";i:1561691687;}*/ ?>
...
<frameset rows="88,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset rows="*" cols="200,12,*" framespacing="0" frameborder="no" border="0" id="pFrame">
    <frame src="<?php echo url('admin/index/leftbar'); ?>" name="leftFrame" scrolling="No" id="leftFrame" title="leftFrame" />
