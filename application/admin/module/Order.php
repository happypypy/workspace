...
//            $Search_arr['dtcreatetime'] = array('<', $request['dtend'] . " 23:59:59");
     ...
     */
    public function addOrder($siteid,$userID,$wxID,$UserName,$dataID, $package_id, $txtfield,$txtdata,$payname,$price,$payCount=1,$OrderSn='',$cashed_amount, $receive_cashed_id,$share_plan_id,$txtfield1='',$txtdata1='',$ischarge=1, $transaction_id = '', $group_buy_order_id = null)
    {
