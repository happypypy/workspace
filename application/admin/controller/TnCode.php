...
class TnCode
{
    ...
    private function _init(){
        ...
        $file_bg = __ROOT__.'/public/static/tncode/bg/'.$bg.'.png';
    ...
    private function _createBg(){
        $file_mark = __ROOT__.'/public/static/tncode/img/mark.png';
        ...
        imagedestroy($im);
       // file_put_contents("aa.txt",$file_mark."==".$this->_x."||".$this->_y."\r\n",8);
    }

    private function _createSlide(){
        $file_mark = __ROOT__.'/public/static/tncode/img/mark2.png';
